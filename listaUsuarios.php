  ...
  <div class="container" id="tituloPagina">
		...
		<form method="post" action="" class="form-inline">
			<div class="form-group">
				...
				<input type="text" name="nome" value="<?php echo $resultado->usuario; ?>" placeholder="Nome:" class="form-control"/>
			</div>
			<div class="form-group">
				<span class="glyphicon glyphicon-lock"></span>
				<input type="password" name="senha" value="<?php echo $resultado->senha; ?>" placeholder="Senha:" class="form-control"/>
			</div>
		...
		<form method="post" action="" class="form-inline">
			...
			<div class="form-group">
				<select class="form-control" name="idgrupousuario">
					<?php
